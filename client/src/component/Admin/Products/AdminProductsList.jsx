...
const AdminProductsList = ({ item, deleteProduct }) => {
  return (
    <tr>
      <td className="px-2 py-2">
        <div className="flex items-center gap-4 w-max">
          ...
          <div className="flex-col gap-2"> 
            ...
            <p className="text-base  text-gray-800"><span className="font-bold">Id</span>:{" "}{item._id}</p>
      ...
      <td className="px-2 py-2">
        ...
        <Link to={`/admin/products/update-product/${item._id}`}>
